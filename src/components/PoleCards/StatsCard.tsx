...
export default function StatsCard({ number, title, description }: StatsCardProps) {
  return (
    <div className='bg-[#E2E2E21A]/70 backdrop-blur-2xl rounded-xl border border-foreground/10 p-5 w-full h-full min-h-[250px] flex flex-col lg:justify-between xl:justify-start'>
